...
public class RateLimitAspect {
     ...
     * {@link WithRateLimitProtection} which should be an HTTP endpoint.
     * Counts calls per remote address. Calls older than {@link #rateDuration}
     * milliseconds will be forgotten. If there have
     * been more than {@link #rateLimit} calls within {@link #rateDuration}
     * milliseconds from a remote address, a {@link RateLimitException}
     * will be thrown.
     * 
     * @throws RateLimitException iff rate limit for a given remote address has been
     *                            exceeded
     */
    @Before("@annotation(com.example.demo.annotation.WithRateLimitProtection)")
